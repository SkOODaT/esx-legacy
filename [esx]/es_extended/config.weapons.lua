...
Config.Weapons = {
	-- Melee
	{name = 'WEAPON_DAGGER', label = _U('weapon_dagger'), components = {}, ammo = {hash = 'AMMO_NONE'}},
	{name = 'WEAPON_BAT', label = _U('weapon_bat'), components = {}, ammo = {hash = 'AMMO_NONE'}},
	{name = 'WEAPON_BATTLEAXE', label = _U('weapon_battleaxe'), components = {}, ammo = {hash = 'AMMO_NONE'}},
	{
		name = 'WEAPON_KNUCKLE',
	...
	{name = 'WEAPON_CROWBAR', label = _U('weapon_crowbar'), components = {}, ammo = {hash = 'AMMO_NONE'}},
	{name = 'WEAPON_FLASHLIGHT', label = _U('weapon_flashlight'), components = {}, ammo = {hash = 'AMMO_NONE'}},
	{name = 'WEAPON_GOLFCLUB', label = _U('weapon_golfclub'), components = {}, ammo = {hash = 'AMMO_NONE'}},
	{name = 'WEAPON_HAMMER', label = _U('weapon_hammer'), components = {}, ammo = {hash = 'AMMO_NONE'}},
	{name = 'WEAPON_HATCHET', label = _U('weapon_hatchet'), components = {}, ammo = {hash = 'AMMO_NONE'}},
	{name = 'WEAPON_KNIFE', label = _U('weapon_knife'), components = {}, ammo = {hash = 'AMMO_NONE'}},
	{name = 'WEAPON_MACHETE', label = _U('weapon_machete'), components = {}, ammo = {hash = 'AMMO_NONE'}},
	{name = 'WEAPON_NIGHTSTICK', label = _U('weapon_nightstick'), components = {}, ammo = {hash = 'AMMO_NONE'}},
	{name = 'WEAPON_WRENCH', label = _U('weapon_wrench'), components = {}, ammo = {hash = 'AMMO_NONE'}},
	{name = 'WEAPON_POOLCUE', label = _U('weapon_poolcue'), components = {}, ammo = {hash = 'AMMO_NONE'}},
	{name = 'WEAPON_STONE_HATCHET', label = _U('weapon_stone_hatchet'), components = {}, ammo = {hash = 'AMMO_NONE'}},
	{
	...
	{name = 'WEAPON_RAYPISTOL', label = _U('weapon_raypistol'), tints = Config.DefaultWeaponTints, components = {}, ammo = {hash = 'AMMO_NONE'}},
	{
	...
	{name = 'WEAPON_DIGISCANNER', label = _U('weapon_digiscanner'), components = {}, ammo = {hash = 'AMMO_NONE'}},
	{name = 'GADGET_PARACHUTE', label = _U('gadget_parachute'), components = {}, ammo = {hash = 'AMMO_NONE'}}
}
