...
function loadESXPlayer(identifier, playerId, isNew)
  local userData = {accounts = {}, inventory = {}, job = {}, loadout = {}, ammotypes = {}, playerName = GetPlayerName(playerId), weight = 0}
  ...
  local xPlayer = CreateExtendedPlayer(playerId, identifier, userData.group, userData.accounts, userData.inventory, userData.weight, userData.job,
    userData.loadout, userData.ammotypes, userData.playerName, userData.coords)
  ...
  xPlayer.triggerEvent('esx:playerLoaded',
    {accounts = xPlayer.getAccounts(), coords = xPlayer.getCoords(), identifier = xPlayer.getIdentifier(), inventory = xPlayer.getInventory(),
     job = xPlayer.getJob(), loadout = xPlayer.getLoadout(), ammotypes = xPlayer.getAmmotype(), maxWeight = xPlayer.getMaxWeight(), money = xPlayer.getMoney(), dead = false}, isNew,
    userData.skin)
...
ESX.RegisterServerCallback('esx:getPlayerData', function(source, cb)
  ...
  cb({identifier = xPlayer.identifier, accounts = xPlayer.getAccounts(), inventory = xPlayer.getInventory(), job = xPlayer.getJob(),
      loadout = xPlayer.getLoadout(), ammotypes = xPlayer.getAmmotype(), money = xPlayer.getMoney(), position = xPlayer.getCoords(true)})
end)
