...
AddEventHandler('esx_licenseshop:buyLicenseAircraft', function()
	...
	if xPlayer.getMoney() >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, _U('license_aircraft'))
	else
...
AddEventHandler('esx_licenseshop:buyLicenseBoating', function()
	...
	if xPlayer.getMoney() >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, _U('license_boating'))
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
	end
end)
...
AddEventHandler('esx_licenseshop:buyLicenseMelee', function()
	...
	if xPlayer.getMoney() >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, _U('license_melee'))
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
	end
end)
...
AddEventHandler('esx_licenseshop:buyLicenseHandgun', function()
	...
	if xPlayer.getMoney() >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, _U('license_handgun'))
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
	end
end)
...
AddEventHandler('esx_licenseshop:buyLicenseSMG', function()
	...
	if xPlayer.getMoney() >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, _U('license_smg'))
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
	end
end)
...
AddEventHandler('esx_licenseshop:buyLicenseShotgun', function()
	...
	if xPlayer.getMoney() >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, _U('license_shotgun'))
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
	end
end)
...
AddEventHandler('esx_licenseshop:buyLicenseAssault', function()
	...
	if xPlayer.getMoney() >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, _U('license_assault'))
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
	end
end)
...
AddEventHandler('esx_licenseshop:buyLicenseLMG', function()
	...
	if xPlayer.getMoney() >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, _U('license_lmg'))
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
	end
end)
...
AddEventHandler('esx_licenseshop:buyLicenseSniper', function()
	...
	if xPlayer.getMoney() >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, _U('license_sniper'))
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
	end
end)
...
-- Buy Heavys License
RegisterServerEvent('esx_licenseshop:buyLicenseHeavy')
AddEventHandler('esx_licenseshop:buyLicenseHeavy', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local price = Config.Prices.Heavy

	if xPlayer.getMoney() >= price then
		xPlayer.removeMoney(price)

		TriggerEvent('esx_license:addLicense', _source, 'weapon_heavy', function()
			LoadLicenses(_source)
		end)
		TriggerClientEvent('esx:showNotification', _source, _U('license_heavy'))
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
	end
end)
...
AddEventHandler('esx_licenseshop:buyLicenseDrivers', function()
	...
	if xPlayer.getMoney() >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, _U('license_drivers'))
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
	end
end)
...
AddEventHandler('esx_licenseshop:buyLicenseDriversP', function()
	...
	if xPlayer.getMoney() >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, _U('license_driversp'))
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
	end
end)
...
AddEventHandler('esx_licenseshop:buyLicenseMotorcyle', function()
	...
	if xPlayer.getMoney() >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, _U('license_motorcycle'))
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
	end
end)
...
AddEventHandler('esx_licenseshop:buyLicenseWeed', function()
	...
	if xPlayer.getMoney() >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, _U('license_weed'))
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
	end
end)
...
AddEventHandler('esx_licenseshop:buyLicenseWeapon', function()
	...
	if xPlayer.getMoney() >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, _U('license_weapon'))
	else
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough_money'))
	end
end)
